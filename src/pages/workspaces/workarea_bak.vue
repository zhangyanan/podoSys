      ...
      <f7-list class="timeline"
        ...
        >
          <div class="notice-date">
            ...
            <div class="timeline-item-date">{{item.活动时间}}</div>
            <div class="timeline-item-time"></div>
          </div>
          <div class="timeline-item-divider"></div>
          <div class="timeline-item-desc " :class="item.类型">{{item.类型}}</div>
          <div class="timeline-item-content">
            <div class="timeline-item-text">{{item.活动名称}}</div>
            <div class="timeline-item-text">{{item.状态}}</div>
            <div class="timeline-item-text">{{item.活动备注}}</div>
          </div>
        </f7-list-item>
      </ul>
      </f7-list>
